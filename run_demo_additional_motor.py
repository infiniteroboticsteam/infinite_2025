...
EXTRA_ATTACHMENT = Motor(Port.C, Direction.CLOCKWISE)
...
async def subtask_test_extra_attachment():
    ...
    for count in range(2):
        ...
        await wait(500)
        await EXTRA_ATTACHMENT.run_time(300, -360) 
